...
if (RESTART == 1):
    ...
    file_path_u = r"D:/numerical computation/geometry meshing/Meshes/Time_stack_u/Time_stack_u_t004200.npz"
    file_path_v = r"D:/numerical computation/geometry meshing/Meshes/Time_stack_v/Time_stack_v_t004200.npz"
    file_path_p = r"D:/numerical computation/geometry meshing/Meshes/Time_stack_p/Time_stack_p_t004200.npz"
...
# ============================================================
    ...
    solution_vector, info = splinalg.gmres(A_gpu,B_gpu, tol = 1e-3, restart=10, maxiter=10)     
    # Continue with your pressure update, velocity correction, etc.
    # ... rest of your code using solution_vector (now on CPU) ...
    # solution_vector = cp.asnumpy(solution_vector).astype(np.float64)
    egmres = time.time()

    #--------------------------------------------------------------------------------------------------------------------------------#
    #                                                       END
    #--------------------------------------------------------------------------------------------------------------------------------#
    # solution_vector, info = splinalg.cg(A_gpu, B_gpu, tol = 1e-3, maxiter = 500)   # Conjugate gradient
    ...
    print("Up time: ",eup-sup," GMRES time: ",egmres-sgmres, " Velocity update: ", enew-snew)
    print("===================================================================================================")
    # time.sleep(900)
eet_main = time.time()
print("")
